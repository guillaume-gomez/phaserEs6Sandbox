...
var Block = function (_Phaser$Sprite) {
  ...
  function Block(game, x, y) {
    var name = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "Block";
    var color = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : _constants.Color;
    var width = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : _constants.WallSize;
    var height = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : _constants.WallSize;
    ...
    var _this = _possibleConstructorReturn(this, (Block.__proto__ || Object.getPrototypeOf(Block)).call(this, game, x, y, bmd));
...
var Corridor = function (_Phaser$Group) {
  ...
  function Corridor(game, parent, x, y, width, height, direction) {
    ...
    var _this = _possibleConstructorReturn(this, (Corridor.__proto__ || Object.getPrototypeOf(Corridor)).call(this, game, parent, _constants.CorridorName, true, true, Phaser.Physics.ARCADE));
...
var Maze = function (_Phaser$Group) {
  ...
  function Maze(game, parent, worldWitdth, worldHeight, nbRooms, arrayOfRoom) {
    ...
    var _this = _possibleConstructorReturn(this, (Maze.__proto__ || Object.getPrototypeOf(Maze)).call(this, game, parent, "maze", false, true, Phaser.Physics.ARCADE));
  ...
  _createClass(Maze, [{
    ...
    value: function generate(game) {
      var JSONData = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
...
var Room = function (_Phaser$Group) {
  ...
  function Room(game, parent, x, y, width, height) {
    ...
    var _this = _possibleConstructorReturn(this, (Room.__proto__ || Object.getPrototypeOf(Room)).call(this, game, parent, _constants.RoomName, true, true, Phaser.Physics.ARCADE));
...
var Wall = function (_Block) {
  ...
  function Wall(game, x, y, key) {
    ...
    return _possibleConstructorReturn(this, (Wall.__proto__ || Object.getPrototypeOf(Wall)).call(this, game, x, y, key, _constants.WallColor, _constants.WallSize, _constants.WallSize));
  }
