...
var MapGenerator = function (_Phaser$Game) {
  ...
  function MapGenerator() {
    ...
    var _this = _possibleConstructorReturn(this, (MapGenerator.__proto__ || Object.getPrototypeOf(MapGenerator)).call(this, 800, 600, Phaser.AUTO, 'content', null));
...
var Corridor = function (_Phaser$Group) {
  ...
  function Corridor(game, parent, x, y, width, height, direction) {
    ...
    var _this = _possibleConstructorReturn(this, (Corridor.__proto__ || Object.getPrototypeOf(Corridor)).call(this, game, parent, "corridor", true, true, Phaser.Physics.ARCADE));
...
var CorridorSprite = function (_Phaser$Sprite) {
  ...
  function CorridorSprite(game, x, y, width, height) {
    var color = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : _constants.Color;
    ...
    var _this = _possibleConstructorReturn(this, (CorridorSprite.__proto__ || Object.getPrototypeOf(CorridorSprite)).call(this, game, x, y, bmd));
...
var Dungeon = function (_Phaser$Group) {
  ...
  function Dungeon(game, parent, worldWitdth, worldHeight, arrayOfRoom) {
    _classCallCheck(this, Dungeon);

    var _this = _possibleConstructorReturn(this, (Dungeon.__proto__ || Object.getPrototypeOf(Dungeon)).call(this, game, parent, "dungeon", false, true, Phaser.Physics.ARCADE));
    ...
    var _loop = function _loop(i) {
      ...
      console.log(width);
      console.log(height);
      var x = (0, _utils.modGrid)(_constants.WallSize, Math.random() * (worldWitdth - width - 1) + 1);
      var y = (0, _utils.modGrid)(_constants.WallSize, Math.random() * (worldHeight - height - 1) + 1);

      var indexChosen = Math.trunc(Math.random() * arrayOfRoom.length);
      var newRoom = Reflect.construct(arrayOfRoom[indexChosen], [game, game.world, x, y, width, height]);
      var failed = false;
    ...
    _this.sortDepth();
    _this.addAdditionalSprite(game);
    return _this;
  }
  ...
  _createClass(Dungeon, [{
    ...
    value: function _import(game, rooms, corridors) {
      ...
      rooms.forEach(function (room) {
        var newRoom = new Room(game, game.world, room.x, room.y, room.w, room.h);
        _this2.createRoom(newRoom);
      });
      corridors.forEach(function (corridor) {
        ...
        _this2.add(newCorridor);
      });
    }
  }, {
    key: 'rooms',
    value: function rooms() {
      var newRoom = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    ...
    value: function removeUselessWalls(game) {
      ...
      this.rooms().forEach(function (room) {
        game.physics.arcade.collide(room.walls(), _this3.corridorSprites(), destroyFunction);
      });

      this.corridors().forEach(function (corridor) {
        game.physics.arcade.collide(corridor.walls(), _this3.roomsSprites(), destroyFunction);
      });

      this.corridors().forEach(function (corridor) {
        _this3.corridors().forEach(function (corridor2) {
    ...
    key: 'exportDebug',
    value: function exportDebug() {
      var roomArray = this.rooms().map(function (m) {
        return { x: m.roomSprite().x, y: m.roomSprite().y, w: m.width, h: m.height };
      });
      var corridorArray = this.corridors().map(function (m) {
        return { x: m.corridorSprite().x, y: m.corridorSprite().y, w: m.width, h: m.height, direction: m.direction };
      });
...
var Room = function (_Phaser$Group) {
  ...
  function Room(game, parent, x, y, width, height) {
    ...
    var _this = _possibleConstructorReturn(this, (Room.__proto__ || Object.getPrototypeOf(Room)).call(this, game, parent, "room", true, true, Phaser.Physics.ARCADE));
...
var RoomSprite = function (_Phaser$Sprite) {
  ...
  function RoomSprite(game, x, y, width, height) {
    ...
    var _this = _possibleConstructorReturn(this, (RoomSprite.__proto__ || Object.getPrototypeOf(RoomSprite)).call(this, game, x, y, bmd));
...
var Wall = function (_Phaser$Sprite) {
  ...
  function Wall(game, x, y) {
    var name = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "Wall";
    ...
    var _this = _possibleConstructorReturn(this, (Wall.__proto__ || Object.getPrototypeOf(Wall)).call(this, game, x, y, bmd));
...
var RoomWithCarpet = function (_Room) {
  ...
  function RoomWithCarpet() {
    ...
    return _possibleConstructorReturn(this, (RoomWithCarpet.__proto__ || Object.getPrototypeOf(RoomWithCarpet)).apply(this, arguments));
  }
...
var RoomWithColoredCorners = function (_Room) {
  ...
  function RoomWithColoredCorners() {
    ...
    return _possibleConstructorReturn(this, (RoomWithColoredCorners.__proto__ || Object.getPrototypeOf(RoomWithColoredCorners)).apply(this, arguments));
  }
...
var GameState = function (_Phaser$State) {
  ...
  _createClass(GameState, [{
    ...
    value: function create() {
      ...
      this.dungeon = new _dungeon2.default(this.game, this.game.world, _constants.WorldWitdth, _constants.WorldHeight, [_room2.default, _roomWithCarpet2.default, _roomWithColoredCorners2.default]);
...
},{"constants/constants":1,"constants/keyUtils":2,"lib/dungeon":7,"lib/room":8,"object/character":12,"object/roomWithCarpet":13,"object/roomWithColoredCorners":14}]},{},[3])
